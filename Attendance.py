...
class Attendance:
    def __init__(self,root):
        ...
        # first Image
        img1= Image.open(r"college_images\MicrosoftTeams-image-246-1024x599.jpg")
        ...
        # second Image
        img2=Image.open(r"college_images\MicrosoftTeams-image-246-1024x599.jpg")
        ...
        # bg Image
        img4= Image.open(r"college_images\MicrosoftTeams-image-246-1024x599.jpg")
        ...
        left_frame.place(x=10,y=10,width=770,height=700)

        left_inside_frame=Frame(left_frame,relief=RIDGE,bd=2)
        left_inside_frame.place(x=0, y=45,width=770,height=600)
        ...
        btn_frame.place(x=30,y=370, width=680,height=35)
        ...
        delete_btn=Button (btn_frame, text="Update", command=self.update_data, width=16, font=("times new roman", 13, "bold"), bg="blue", fg="white")
        ...
        table_frame.place(x=5,y=0,width=720,height=450)
    ...
    def update_data(self):
        try:
            ...
            selected_item = self.AttendaceReportTable.selection()[0]
            self.AttendaceReportTable.item(selected_item, values=(attendance_id, roll, name, department, time, date, attendance))

            messagebox.showinfo("Success", "Record updated successfully.", parent=self.root)

            # Reset entry fields after update
            self.reset_Data()
